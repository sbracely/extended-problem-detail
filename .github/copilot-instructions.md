...
- The project is the Spring Boot 3 line of the starter. Module POMs use Spring Boot `3.5.14`; README compatibility says Java 17+.
...
- MVC example tests mostly use `@AutoConfigureMockMvc` with `MockMvcTester`; random-port MVC tests live in dedicated `*RandomPortTests` / `*MultipartLimitTests` classes.
